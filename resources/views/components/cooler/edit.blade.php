...
<div class="container">
  <div class="d-flex justify-content-center">
      <div class="card h-100">
          ...
          <div class="card-body">
          <form action="{{ route('components.update', ['component' => $component->id, 'type' => 'cooler']) }}" method="POST">
              @csrf
              @method('PUT')
                  ...
                  <div class="input-group form-group">
                    ...
                    <input name="capacity" id="capacity" type="number" class="form-control" placeholder="Fans RPM" value="{{ $component->capacity }}">
                </div>
                <div class="input-group form-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-barcode"></i></span>
                    </div>
                    <input name="noise" id="noise" type="text" class="form-control" placeholder="noise" value="{{ $component->noise }}">
                </div>
                <div class="input-group form-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-barcode"></i></span>
                    </div>
                    <input name="size" id="size" type="text" class="form-control" placeholder="size" value="{{ $component->size }}">
                </div>
                <div class="input-group form-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-barcode"></i></span>
                    </div>
                    <input name="radiator" id="radiator" type="text" class="form-control" placeholder="radiator" value="{{ $component->radiator }}">
                </div>
