...
<div class="container">
  <div class="d-flex justify-content-center">
      <div class="card h-100">
          ...
          <div class="card-body">
          <form action="{{ route('components.update', ['component' => $component->id, 'type' => 'ssd']) }}" method="POST">
              @csrf
              @method('PUT')
                  ...
                  <div class="input-group form-group">
                    ...
                    <input name="capacity" id="capacity" type="number" class="form-control" placeholder="space (GB)" value="{{ $component->capacity }}">
                </div>
                <div class="input-group form-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-microchip"></i></span>
                    </div>
                    <input name="cache" id="cache" type="text" class="form-control" placeholder="cache" value="{{ $component->cache }}">
                </div>
                <div class="input-group form-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-barcode"></i></span>
                    </div>
                    <input name="interface" id="interface" type="text" class="form-control" placeholder="interface" value="{{ $component->interface }}">
                </div>
